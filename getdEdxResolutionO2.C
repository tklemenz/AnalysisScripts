...
int getdEdxResolutionO2(TString FileList, TString GainMap="", const char *OutputPath="/home/tom/myana/Results")
{
  ...
  TFile *OutFile = new TFile(Form("%s/anaOut_count_pi_e.root", OutputPath), "recreate");
  TTree *TrackAna = new TTree("TrackAna","dEdxAna");

  TrackAna->Branch("Pions", &pions, "pions/I");
  TrackAna->Branch("Electrons", &electrons, "electrons/I");
