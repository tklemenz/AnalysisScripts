...
int getdEdxResolutionO2_batch(TString FileList, TString GainMap="", const char *OutputPath="/home/tom/myana/Results")
{
...
/*========================================== CUT ================================================*/
        ...
        if (isok == true){																			// track accepted
          ...
          if (setting == 0) {
            dEdxTot = trackObject.getTruncatedMean(runNr, .0, .65, 1, false, false, true, hCheckExclude, 1, 2, &nClTruncTot);//, hTruncTrack[eventcounter], hChargeDistTrack[eventcounter]);
            dEdxMax = trackObject.getTruncatedMean(runNr, .0, .65, 0, false, false, true, hCheckExclude, 1, 2, &nClTruncMax);//, hTruncTrack[eventcounter], hChargeDistTrack[eventcounter]);
