...
int get_2gainmaps_o2_Landau(TString FileList, TString GainMap="", const char *OutputPath="/home/tom/myana/Results") {
...
//      gainmapplot->Draw("colz");
  ...
  TH1D *hGainDistS0Landau       = new TH1D("NGDS1Landau", "; Normalized gain; Counts",100,0,2);
  TH1D *hGainDistS1Landau       = new TH1D("NGDS2Landau", "; Normalized gain; Counts",100,0,2);
  TH2D *hGainMapHistoS0Landau   = new TH2D("GainMapS0Landau", "; Row; Pad; Normalized gain", 63,0,63,100,-50,50);
  TH2D *hGainMapHistoS1Landau   = new TH2D("GainMapS1Landau", "; Row; Pad; Normalized gain", 63,0,63,100,-50,50);
  TH2D *hGainMapRatioS0         = new TH2D("GainMapRatioS0", "; Row; Pad; Ratio", 63,0,63,100,-50,50);
  TH1F *hRatioDistS0            = new TH1F("hRatioDistS0","; Ratio; Counts", 500,0,5);
  TH2D *hGainMapRatioS1         = new TH2D("GainMapRatioS1", "; Row; Pad; Ratio", 63,0,63,100,-50,50);
  TH1F *hRatioDistS1            = new TH1F("hRatioDistS1","; Ratio; Counts", 500,0,5);
  TH1F *hChiSquareDistLandauPiS0     = new TH1F("hChiSquareDistLandauPiS0","; ChiSquare; Counts", 500,0,25);
  TH1F *hChiSquareDistLandauPiS1     = new TH1F("hChiSquareDistLandauPiS1","; ChiSquare; Counts", 500,0,25);
  TH2D *hChiSquareLandauPiS0         = new TH2D("hChiSquareLandauPiS0", "; Row; Pad; ChiSquare", 63,0,63,100,-50,50);
  TH2D *hChiSquareLandauPiS1         = new TH2D("hChiSquareLandauPiS1", "; Row; Pad; ChiSquare", 63,0,63,100,-50,50);
  TH1F *hChiSquareDistLandauEleS0     = new TH1F("hChiSquareDistLandauEleS0","; ChiSquare; Counts", 500,0,25);
  TH1F *hChiSquareDistLandauEleS1     = new TH1F("hChiSquareDistLandauEleS1","; ChiSquare; Counts", 500,0,25);
  TH2D *hChiSquareLandauEleS0         = new TH2D("hChiSquareLandauEleS0", "; Row; Pad; ChiSquare", 63,0,63,100,-50,50);
  TH2D *hChiSquareLandauEleS1         = new TH2D("hChiSquareLandauEleS1", "; Row; Pad; ChiSquare", 63,0,63,100,-50,50);
  ...
  const int nrows = 63;
  const int npads = 100;
  TH1F *hQtotPadsPiS0[nrows][npads];
  TH1F *hQtotPadsPiS1[nrows][npads];
  ...
  TH1F *hQtotMPVPiS0[nrows][npads];
  TH1F *hQtotMPVPiS1[nrows][npads];
//  TF1 *MPVfitPiS0[nrows][npads];
//  TF1 *MPVfitPiS1[nrows][npads];


  for(int irow=0; irow<nrows; ++irow) {
    for (int ipad=0; ipad<npads; ++ipad) {
    hQtotPadsPiS0[irow][ipad] = new TH1F(Form("hQtotPadPi_LandauS0_%i_%i", irow, ipad), "; Q_{tot}/<dE/dx>_{tr} [a.u.]; Counts", 500, 0, 50);
    hQtotPadsPiS1[irow][ipad] = new TH1F(Form("hQtotPadPi_LandauS1_%i_%i", irow, ipad), "; Q_{tot}/<dE/dx>_{tr} [a.u.]; Counts", 500, 0, 50);
    ...
    hQtotTruncMeanPiS0[irow][ipad] = new TH1F(Form("hQtotTruncMeanPi_S0_%i_%i", irow, ipad), "; Truncated mean",500,0,2);
    hQtotTruncMeanPiS1[irow][ipad] = new TH1F(Form("hQtotTruncMeanPi_S1_%i_%i", irow, ipad), "; Truncated mean",500,0,2);
    hQtotMPVPiS0[irow][ipad] = new TH1F(Form("hQtotMPVPi_S0_%i_%i", irow, ipad), "; MPV",500,0,2);
    hQtotMPVPiS1[irow][ipad] = new TH1F(Form("hQtotMPVPi_S1_%i_%i", irow, ipad), "; MPV",500,0,2);
//    MPVfitPiS0[irow][ipad] = new TF1(Form("MPVPi_S0_%i_%i", irow, ipad),"landau",0,20);
//    MPVfitPiS1[irow][ipad] = new TF1(Form("MPVPi_S1_%i_%i", irow, ipad),"landau",0,20);
    }
  }

  TH1F *hQtotPadsEleS0[nrows][npads];
  TH1F *hQtotPadsEleS1[nrows][npads];
  ...
  TH1F *hQtotMPVEleS0[nrows][npads];
  TH1F *hQtotMPVEleS1[nrows][npads];
//  TF1 *MPVfitEleS0[nrows][npads];
//  TF1 *MPVfitEleS1[nrows][npads];


  for(int irow=0; irow<nrows; ++irow) {
    for (int ipad=0; ipad<npads; ++ipad) {
    hQtotPadsEleS0[irow][ipad] = new TH1F(Form("hQtotPadEle_LandauS0_%i_%i", irow, ipad), "; Q_{tot}/<dE/dx>_{tr} [a.u.]; Counts", 500, 0, 50);
    hQtotPadsEleS1[irow][ipad] = new TH1F(Form("hQtotPadEle_LandauS1_%i_%i", irow, ipad), "; Q_{tot}/<dE/dx>_{tr} [a.u.]; Counts", 500, 0, 50);
    ...
    hQtotTruncMeanEleS0[irow][ipad] = new TH1F(Form("hQtotTruncMeanEle_S0_%i_%i", irow, ipad), "; Truncated mean",500,0,2);
    hQtotTruncMeanEleS1[irow][ipad] = new TH1F(Form("hQtotTruncMeanEle_S1_%i_%i", irow, ipad), "; Truncated mean",500,0,2);
    hQtotMPVEleS0[irow][ipad] = new TH1F(Form("hQtotMPVEle_S0_%i_%i", irow, ipad), "; MPV",500,0,2);
    hQtotMPVEleS1[irow][ipad] = new TH1F(Form("hQtotMPVEle_S1_%i_%i", irow, ipad), "; MPV",500,0,2);
//    MPVfitEleS0[irow][ipad] = new TF1(Form("MPVEle_S0_%i_%i", irow, ipad),"landau",0,20);
//    MPVfitEleS1[irow][ipad] = new TF1(Form("MPVEle_S1_%i_%i", irow, ipad),"landau",0,20);
    }
  }
      ...
      if (isok == true){																			// track accepted
        ...
        if (CherenkovValue < CherCutLow){
              for (auto &clusterObject : clCont) {															// loop over clusters
                ...
                if (runNr <= 243) {
                  hQtotPadsPiS0[row][pad]->Fill(QTot/dEdx);
                  hQtotPadsTruncPiS0[row][pad]->Fill(QTot/dEdx);
                }
                else if (runNr > 255) {
                  hQtotPadsPiS1[row][pad]->Fill(QTot/dEdx);
        ...
        if (CherenkovValue > CherCutHigh){
              for (auto &clusterObject : clCont) {															// loop over clusters
                ...
                if (runNr <= 243) {
                  hQtotPadsEleS0[row][pad]->Fill(QTot/dEdx);
                  hQtotPadsTruncEleS0[row][pad]->Fill(QTot/dEdx);
                }
                else if (runNr > 255) {
                  hQtotPadsEleS1[row][pad]->Fill(QTot/dEdx);
...
//  TFile *gGM = TFile::Open("GainMap_Histo.root", "recreate");
  ...
  CalDet<float> *gainmapEleS0Landau = new CalDet<float>(PadSubset::ROC);
  gainmapEleS0Landau->setName("GainMapEle");
  CalArray<float>& GainMapEleS0Landau = gainmapEleS0Landau->getCalArray(roc);

  CalDet<float> *gainmapPiS0Landau = new CalDet<float>(PadSubset::ROC);
  gainmapPiS0Landau->setName("GainMapPi");
  CalArray<float>& GainMapPiS0Landau = gainmapPiS0Landau->getCalArray(roc);

  CalDet<float> *gainmapEleS1Landau = new CalDet<float>(PadSubset::ROC);
  gainmapEleS1Landau->setName("GainMapEle");
  CalArray<float>& GainMapEleS1Landau = gainmapEleS1Landau->getCalArray(roc);

  CalDet<float> *gainmapPiS1Landau = new CalDet<float>(PadSubset::ROC);
  gainmapPiS1Landau->setName("GainMapPi");
  CalArray<float>& GainMapPiS1Landau = gainmapPiS1Landau->getCalArray(roc);
...
//    }
      ...
      if (entriesPiS0 > 0){
        GetBinMinMax(hQtotPadsPiS0[irow][ipad],frac,bin1,bin2);
//        hQtotPadsPiS0[irow][ipad]->Fit(Form("MPVPi_S0_%i_%i", irow, ipad),"NQ0","", hQtotPadsPiS0[irow][ipad]->GetXaxis()->GetBinLowEdge(bin1),hQtotPadsPiS0[irow][ipad]->GetXaxis()->GetBinUpEdge(bin2));
//        float mpv = MPVfitPiS0[irow][ipad]->GetParameter(1);
        hQtotPadsPiS0[irow][ipad]->Fit("MPV","NQ0","", hQtotPadsPiS0[irow][ipad]->GetXaxis()->GetBinLowEdge(bin1),hQtotPadsPiS0[irow][ipad]->GetXaxis()->GetBinUpEdge(bin2));
        float mpv = MPVfit->GetParameter(1);
        GainMapPiS0Landau.setValue(irow,ipad,mpv);
//        
        float chisquare = MPVfit->GetChisquare()/MPVfit->GetNDF();
        hChiSquareLandauPiS0->Fill(irow,cpad,chisquare);
        hChiSquareDistLandauPiS0->Fill(chisquare);
        hQtotMPVPiS0[irow][ipad]->SetLineColor(kRed);
        for (int i = 0; i <= 5000 ; ++i) {
          hQtotMPVPiS0[irow][ipad]->Fill(mpv);
        }
...
//        ++Landau;
        ...
        hQtotTruncMeanPiS0[irow][ipad]->SetLineColor(kGreen);
        for (int i = 0; i <= 5000 ; ++i) {
      ...
      if (entriesPiS1 > 0) {
        GetBinMinMax(hQtotPadsPiS1[irow][ipad],frac,bin1,bin2);
//        hQtotPadsPiS1[irow][ipad]->Fit(Form("MPVPi_S1_%i_%i", irow, ipad),"NQ0","", hQtotPadsPiS1[irow][ipad]->GetXaxis()->GetBinLowEdge(bin1),hQtotPadsPiS1[irow][ipad]->GetXaxis()->GetBinUpEdge(bin2));
//        float mpv = MPVfitPiS1[irow][ipad]->GetParameter(1);
        hQtotPadsPiS1[irow][ipad]->Fit("MPV","NQ0","", hQtotPadsPiS1[irow][ipad]->GetXaxis()->GetBinLowEdge(bin1),hQtotPadsPiS1[irow][ipad]->GetXaxis()->GetBinUpEdge(bin2));
        float mpv = MPVfit->GetParameter(1);
        GainMapPiS1Landau.setValue(irow,ipad,mpv);
//        float chisquare = MPVfitPiS1[irow][ipad]->GetChisquare()/MPVfitPiS1[irow][ipad]->GetNDF();
        float chisquare = MPVfit->GetChisquare()/MPVfit->GetNDF();        
        hChiSquareLandauPiS1->Fill(irow,cpad,chisquare);
        hChiSquareDistLandauPiS1->Fill(chisquare);
        hQtotMPVPiS1[irow][ipad]->SetLineColor(kRed);
        for (int i = 0; i <= 5000 ; ++i) {
          hQtotMPVPiS1[irow][ipad]->Fill(mpv);
        }
        param[0]=0;
        param[1]=0;
        param[2]=0;
        ...
        hQtotTruncMeanPiS1[irow][ipad]->SetLineColor(kGreen);
        for (int i = 0; i <= 5000 ; ++i) {
...
//      }
      ...
      if (entriesEleS0 > 0){
        GetBinMinMax(hQtotPadsEleS0[irow][ipad],frac,bin1,bin2);
//        hQtotPadsEleS0[irow][ipad]->Fit(Form("MPVEle_S0_%i_%i", irow, ipad),"NQ0","", hQtotPadsEleS0[irow][ipad]->GetXaxis()->GetBinLowEdge(bin1),hQtotPadsEleS0[irow][ipad]->GetXaxis()->GetBinUpEdge(bin2));
//        float mpv = MPVfitEleS0[irow][ipad]->GetParameter(1);
        hQtotPadsEleS0[irow][ipad]->Fit("MPV","NQ0","", hQtotPadsEleS0[irow][ipad]->GetXaxis()->GetBinLowEdge(bin1),hQtotPadsEleS0[irow][ipad]->GetXaxis()->GetBinUpEdge(bin2));
        float mpv = MPVfit->GetParameter(1);
        GainMapEleS0Landau.setValue(irow,ipad,mpv);

//        float chisquare = MPVfitEleS0[irow][ipad]->GetChisquare()/MPVfitEleS0[irow][ipad]->GetNDF();
        float chisquare = MPVfit->GetChisquare()/MPVfit->GetNDF();        
        hChiSquareLandauEleS0->Fill(irow,cpad,chisquare);
        hChiSquareDistLandauEleS0->Fill(chisquare);
        hQtotMPVEleS0[irow][ipad]->SetLineColor(kRed);
        for (int i = 0; i <= 5000 ; ++i) {
          hQtotMPVEleS0[irow][ipad]->Fill(mpv);
        }
//        float chisquare = MPVfit->GetChisquare()/MPVfit->GetNDF();
...
//        ++Landau;
        ...
        hQtotTruncMeanEleS0[irow][ipad]->SetLineColor(kGreen);
        for (int i = 0; i <= 5000 ; ++i) {
      ...
      if (entriesEleS1 > 0) {
        GetBinMinMax(hQtotPadsEleS1[irow][ipad],frac,bin1,bin2);
//        hQtotPadsEleS1[irow][ipad]->Fit(Form("MPVEle_S1_%i_%i", irow, ipad),"NQ0","", hQtotPadsEleS1[irow][ipad]->GetXaxis()->GetBinLowEdge(bin1),hQtotPadsEleS1[irow][ipad]->GetXaxis()->GetBinUpEdge(bin2));
//        float mpv = MPVfitEleS1[irow][ipad]->GetParameter(1);
        hQtotPadsEleS1[irow][ipad]->Fit("MPV","NQ0","", hQtotPadsEleS1[irow][ipad]->GetXaxis()->GetBinLowEdge(bin1),hQtotPadsEleS1[irow][ipad]->GetXaxis()->GetBinUpEdge(bin2));
        float mpv = MPVfit->GetParameter(1);
        GainMapEleS1Landau.setValue(irow,ipad,mpv);
//        float chisquare = MPVfitEleS1[irow][ipad]->GetChisquare()/MPVfitEleS1[irow][ipad]->GetNDF();
        float chisquare = MPVfit->GetChisquare()/MPVfit->GetNDF();
        hChiSquareLandauEleS1->Fill(irow,cpad,chisquare);
        hChiSquareDistLandauEleS1->Fill(chisquare);
        hQtotMPVEleS1[irow][ipad]->SetLineColor(kRed);
        for (int i = 0; i <= 5000 ; ++i) {
          hQtotMPVEleS1[irow][ipad]->Fill(mpv);
        }
        param[0]=0;
        param[1]=0;
        param[2]=0;
        ...
        hQtotTruncMeanEleS1[irow][ipad]->SetLineColor(kGreen);
        for (int i = 0; i <= 5000 ; ++i) {
...
//  delete gTrEle;
  ...
  CalDet<float> *gainmapS0Landau = new CalDet<float>(PadSubset::ROC);
  gainmapS0Landau->setName("GainMap");
  CalArray<float>& GainMapS0Landau = gainmapS0Landau->getCalArray(roc);

  for (int irow = 0; irow<63; ++irow) {
    for (int ipad = 0; ipad<100; ++ipad){
      if (TMath::IsNaN(gainmapPiS0Landau->getValue(roc, irow, ipad))) {
        GainMapPiS0Landau.setValue(irow, ipad, 0);
      }
      if (TMath::IsNaN(gainmapPiS1Landau->getValue(roc, irow, ipad))) {
        GainMapPiS1Landau.setValue(irow, ipad, 0);
      }
      if (TMath::IsNaN(gainmapEleS0Landau->getValue(roc, irow, ipad))) {
        GainMapEleS0Landau.setValue(irow, ipad, 0);
      }
      if (TMath::IsNaN(gainmapEleS1Landau->getValue(roc, irow, ipad))) {
        GainMapEleS1Landau.setValue(irow, ipad, 0);
      }
    }
  }
...
/*================================ fill Gain map S0 ======================================*/
  ...
  for (int irow = 0; irow<63; ++irow) {
    for (int ipad = 0; ipad<100; ++ipad){
      float pival = gainmapPiS0Landau->getValue(roc, irow, ipad);
      float eleval = gainmapEleS0Landau->getValue(roc, irow, ipad);
      if (pival != 0 || eleval != 0) {
        float mean = (pival+eleval)/2;
        float cpad = ipad - mapper.getNumberOfPadsInRowSector(irow)/2;
        GainMapS0Landau.setValue(irow, ipad, mean);
        hGainMapHistoS0Landau->Fill(irow, cpad, mean);
        //if (mean > .7) {
          hGainDistS0Landau->Fill(mean);
        //}
      }
    }
  }
  ...
  CalDet<float> *gainmapS1Landau = new CalDet<float>(PadSubset::ROC);
  gainmapS1Landau->setName("GainMap");
  CalArray<float>& GainMapS1Landau = gainmapS1Landau->getCalArray(roc);

  for (int irow = 0; irow<63; ++irow) {
    for (int ipad = 0; ipad<100; ++ipad){
      float pival = gainmapPiS1Landau->getValue(roc, irow, ipad);
      float eleval = gainmapEleS1Landau->getValue(roc, irow, ipad);
      if (pival != 0 || eleval != 0) {
        float mean = (pival+eleval)/2;
        float cpad = ipad - mapper.getNumberOfPadsInRowSector(irow)/2;
        GainMapS1Landau.setValue(irow, ipad, mean);
        hGainMapHistoS1Landau->Fill(irow, cpad, mean);
        //if (mean > .7) {
          hGainDistS1Landau->Fill(mean);
        //}
      }
    }
  }
  ...
  for (int irow = 0; irow<63; ++irow) {
    for (int ipad = 0; ipad<100; ++ipad){
      float s0 = gainmapS0->getValue(roc, irow, ipad);
      float s1 = gainmapS1->getValue(roc, irow, ipad);
      float s0Landau = gainmapS0Landau->getValue(roc, irow, ipad);
      float s1Landau = gainmapS1Landau->getValue(roc, irow, ipad);
      float cpad = ipad - mapper.getNumberOfPadsInRowSector(irow)/2;
      if (s0 != 0) {
        hGainMapRatioS0->Fill(irow,cpad,s0Landau/s0);
        hRatioDistS0->Fill(s0Landau/s0);
      }
      if (s1 != 0) {
        hGainMapRatioS1->Fill(irow,cpad,s1Landau/s1);
        hRatioDistS1->Fill(s1Landau/s1);
      }
    }
  }
...
//  gmplot->Draw("colz");
  ...
  TFile *LandauMap = TFile::Open(Form("%s/GainMap2_Landau.root", OutputPath), "recreate");
  LandauMap->WriteObject(gainmapS0Landau, "GainMapS0");
  LandauMap->WriteObject(gainmapS1Landau, "GainMapS1");
  delete LandauMap;
...
//  delete gGM;
  ...
  TFile *g = TFile::Open(Form("%s/GainMap_Histos2_Landau.root", OutputPath), "recreate");
  g->WriteObject(hGainMapHistoS0, "GainMapS0");
  g->WriteObject(hGainMapHistoS1, "GainMapS1");
  g->WriteObject(hGainMapHistoS0Landau, "GainMapS0Landau");
  g->WriteObject(hGainMapHistoS1Landau, "GainMapS1Landau");
  g->WriteObject(hGainMapRatioS0, "hGainMapRatioS0");
  g->WriteObject(hGainMapRatioS1, "hGainMapRatioS1");
  g->WriteObject(hRatioDistS0, "hRatioDistS0");
  g->WriteObject(hRatioDistS1, "hRatioDistS1");
  g->WriteObject(hChiSquareLandauPiS0, "hChiSquareLandauPiS0");
  g->WriteObject(hChiSquareLandauPiS1, "hChiSquareLandauPiS1");
  g->WriteObject(hChiSquareDistLandauPiS0, "hChiSquareDistLandauPiS0");
  g->WriteObject(hChiSquareDistLandauPiS1, "hChiSquareDistLandauPiS1");
  g->WriteObject(hChiSquareLandauEleS0, "hChiSquareLandauEleS0");
  g->WriteObject(hChiSquareLandauEleS1, "hChiSquareLandauEleS1");
  g->WriteObject(hChiSquareDistLandauEleS0, "hChiSquareDistLandauEleS0");
  g->WriteObject(hChiSquareDistLandauEleS1, "hChiSquareDistLandauEleS1");
  ...
  g->WriteObject(hGainDistS0Landau, "GainDistributionS0Landau");
  g->WriteObject(hGainDistS1Landau, "GainDistributionS1Landau");
  ...
  for (int irow=0; irow<nrows; ++irow){
    for (int ipad=0; ipad<npads; ++ipad){
      if (hQtotPadsTruncPiS0[irow][ipad]->GetEntries() > 0) {
        ...
        g->WriteObject(hQtotPadsPiS0[irow][ipad],Form("hQtotPadPi_LandauS0_%i_%i",irow, ipad));
        //g->WriteObject(MPVfitPiS0[irow][ipad],Form("MPVPi_S0_%i_%i", irow, ipad));
        g->WriteObject(hQtotMPVPiS0[irow][ipad],Form("hQtotMPVPiS0_%i_%i",irow, ipad));
      }
      if (hQtotPadsTruncEleS0[irow][ipad]->GetEntries() > 0) {
        ...
        g->WriteObject(hQtotPadsEleS0[irow][ipad],Form("hQtotPadEle_LandauS0_%i_%i",irow, ipad));
        //g->WriteObject(MPVfitPiS1[irow][ipad],Form("MPVPi_S1_%i_%i", irow, ipad));
        g->WriteObject(hQtotMPVEleS0[irow][ipad],Form("hQtotMPVEleS0_%i_%i",irow, ipad));
      }
      if (hQtotPadsTruncPiS1[irow][ipad]->GetEntries() > 0) {
        ...
        g->WriteObject(hQtotPadsPiS1[irow][ipad],Form("hQtotPadPi_LandauS1_%i_%i",irow, ipad));
        //g->WriteObject(MPVfitEleS0[irow][ipad],Form("MPVEle_S0_%i_%i", irow, ipad));
        g->WriteObject(hQtotMPVPiS1[irow][ipad],Form("hQtotMPVPiS1_%i_%i",irow, ipad));
      }
      if (hQtotPadsTruncEleS1[irow][ipad]->GetEntries() > 0) {
        ...
        g->WriteObject(hQtotPadsEleS1[irow][ipad],Form("hQtotPadEle_LandauS1_%i_%i",irow, ipad));
        //g->WriteObject(MPVfitEleS1[irow][ipad],Form("MPVEle_S1_%i_%i", irow, ipad));
        g->WriteObject(hQtotMPVEleS1[irow][ipad],Form("hQtotMPVEleS1_%i_%i",irow, ipad));
      }
    }
  }
  delete g;
