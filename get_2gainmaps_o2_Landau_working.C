...
int get_2gainmaps_o2_Landau_working(TString FileList, TString GainMap="", const char *OutputPath="/home/tom/myana/Results") {
...
//  gmplot->Draw("colz");
  ...
  TFile *f = TFile::Open(Form("%s/GainMap2_working.root", OutputPath), "recreate");
  f->WriteObject(gainmapS0, "GainMapS0");
  f->WriteObject(gainmapS1, "GainMapS1");
  delete f;

  TFile *LandauMap = TFile::Open(Form("%s/GainMap2_Landau_working.root", OutputPath), "recreate");
...
//  delete gGM;
  ...
  TFile *g = TFile::Open(Form("%s/GainMap_Histos2_Landau_working.root", OutputPath), "recreate");
